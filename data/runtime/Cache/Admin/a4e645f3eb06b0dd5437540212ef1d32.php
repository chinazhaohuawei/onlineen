...
<div class="wrap jj">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo U('videomanage');?>">课程管理</a></li>
        <li class="active"><a href="">修改课程</a></li>
    </ul>
    <div class="common-form">
        <form method="post" class="form-horizontal J_ajaxForm" action="<?php echo U('changecourse_post');?>">
            <fieldset>
                <div class="control-group">
                    <label class="control-label">课程id:</label>
                    <div class="controls">
                        <input type="text" class="control-myinput" name="course_id" value="<?php echo ($course['courseid']); ?>" readonly>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="control-myinput" name="course_title" value="<?php echo ($course['course_title']); ?>">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="control-myinput" name="resource_type">
                            <?php if(is_array($course_type)): foreach($course_type as $key=>$vo): if($vo['type_id'] == $course['course_type']): ?><option value="<?php echo ($vo["type_id"]); ?>" selected><?php echo ($vo["type_name"]); ?></option>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="control-myinput" name="resource_url" value="<?php echo ($course['course_down']); ?>">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php if($resource['resource_pic']): $resource_pic_string=$resource['course_pic']; ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea type="text" class="control-mytextarea" name="resource_info"><?php echo ($course['course_info']); ?></textarea>
                    </div>
                </div>
            </fieldset>
            <div class="form-actions">
                ...
                <a class="btn" href="/onlineen0328/index.php/Admin/VideoManage/resourcelist">返回</a>
                <!--<a class="btn" href="/onlineen0328/index.php/Admin/VideoManage/schoollist">清除</a>-->
            </div>
        </form>
    </div>
</div>
