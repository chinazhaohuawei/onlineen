...
<![endif]-->
    <title><?php echo ($resource['resource_name']); ?>免费下载-<?php echo ($resource['typename']); ?>-英语在线-www.onlineen.cn</title>
</head>
<body>
...
<div class="horizontal-advert-place">
    ...
    <div class="main">
        <div class="title"><?php echo ($resource['resource_name']); ?></div>
        <div class="resource-detail">
            <img class="resource-pic" src="/onlineen0328/data/upload/resource/<?php echo ($resource['resource_pic']); ?>">
            <div class="resource-info">
                <h3><?php echo ($resource['resource_name']); ?></h3>
                <p><span>类型：</span><?php echo ($resource['typename']); ?></p>
                <p><span>资源大小：</span><?php echo ($resource['resource_size']); ?></p>
                <p><span>更新日期：</span><?php echo (date('Y-m-d',$resource['resource_time'])); ?></p>
                <p><span>资料简介：</span><?php echo ($resource['resource_info']); ?></p>
                <a href="<?php echo U('Down/Index/downdetail',array('id'=>$resource['resource_id']));?>" target="_blank">
                    <button>立即下载</button>
                </a>
            </div>
            <div class="clear"></div>
