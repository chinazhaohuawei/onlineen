...
<div class="horizontal-advert-place">
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                <div class="row-fluid">
                    <div class="span3">
                        <img class="img-thumbnail" src="/tpl/onlineenweb/Public/images/practice_test.png">
                    </div>
                    <div class="span9">
                        <h1>综合模拟考试</h1>
    ...
    <div id="myTabContent" class="tab-content">
        <?php if(is_array($question_arr)): foreach($question_arr as $key=>$vo): ?><div class="tab-pane fade in active" id="<?php echo ($vo); ?>">
