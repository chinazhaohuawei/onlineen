        ...
        <div class="c_details_main">
            ...
            <?php if(is_array($video_data)): foreach($video_data as $key=>$vo): ?><div class="course_list">
                <a href="<?php echo U('Portal/Course/video',array('courseid'=>$vo['course_id'],'videoid'=>$vo['video_id']));?>" target="_blank">
                    <img style='background: url("/onlineen0328/data/video/<?php echo ($vo["video_pic"]); ?>"); background-size: 124px 85px;' src="/onlineen0328/tpl/onlineenweb//Public/images/playwidth.png" title="<?php echo ($vo["video_info"]); ?>">
                </a>
                <div class="right">
                    <h3>
