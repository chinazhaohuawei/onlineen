            ...
            <div class="course_right">
                ...
                <?php if(is_array($course_data)): foreach($course_data as $key=>$vo): ?><div class="course_list">
                        <a href="<?php echo U('Portal/Course/index',array('courseid'=>$vo['courseid']));?>" target="_blank">
                            <img  style='background: url("/git-onlineen/https-::github.com:chinazhaohuawei:onlineen.git/data/upload/course/<?php echo ($vo["course_pic"]); ?>");background-size: 125px 125px;' src="/git-onlineen/https-::github.com:chinazhaohuawei:onlineen.git/tpl/onlineenweb//Public/images/play.png">
                        </a>
...
<script type="text/javascript">
	var gVars = {
		'ROOT' : '/git-onlineen/https-::github.com:chinazhaohuawei:onlineen.git',
	}
</script>

<script src="/git-onlineen/https-::github.com:chinazhaohuawei:onlineen.git/tpl/onlineenweb/Public/js/jquery-1.11.3.min.js"></script>
<script src="/git-onlineen/https-::github.com:chinazhaohuawei:onlineen.git/tpl/onlineenweb/Public/js/bootstrap.min.js"></script>
